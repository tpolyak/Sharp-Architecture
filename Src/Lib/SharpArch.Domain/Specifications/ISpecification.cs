...
public interface ISpecification<T>
{
    ...
    /// <returns>
    ///     A value indicating whether the current specification is a generalisation of the supplied specification.
    /// </returns>
    ...
    /// <param name="specification">The specification to test.</param>
    /// <returns>
    ///     A value indicating whether the current specification is a special case version of the supplied specification.
    /// </returns>
