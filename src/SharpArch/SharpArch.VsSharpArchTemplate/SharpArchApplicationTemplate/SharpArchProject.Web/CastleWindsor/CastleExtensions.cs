...
namespace $safeprojectname$.CastleWindsor
{
    ...
    {
        /// <summary>
        /// Searches for the first interface found associated with the <see cref="ServiceDescriptor" /> 
        /// which is not generic and which is found in the specified namespace.
        /// </summary>
