namespace SharpArch.Data.NHibernate
{
   ...
   public class NHibernateConfigurationFileCache : INHibernateConfigurationCache
   {
       ...
       public Configuration LoadConfiguration(string configKey, string configFile, string[] mappingAssemblies) {
           ...
           try {
               using (FileStream file = File.Open(SeralizedConfigFileName(configKey), FileMode.Open)) {
       ...
       public void SaveConfiguration(string configKey, Configuration config) {
           using (FileStream file = File.Open(SeralizedConfigFileName(configKey), FileMode.Create)) {
       ...
       private static bool IsSeralizedConfigCurrent(string cacheFile, string configFile, string[] mappingAssemblies) {
       ...
       private static string SeralizedConfigFileName(string configKey) {
