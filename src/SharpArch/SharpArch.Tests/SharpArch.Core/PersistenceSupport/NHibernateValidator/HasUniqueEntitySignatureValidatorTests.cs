...
namespace Tests.SharpArch.Core.PersistenceSupport.NHibernateValidator
{
    [TestFixture]
    public class HasUniqueObjectSignatureValidatorTests
    {
        ...
        public void CanVerifyThatDuplicateExistsDuringValidationProcess() {
            ...
            InvalidValue[] invalidValues = contractor.GetValidationMessages();
        ...
        public void MayNotUseValidatorWithEntityHavingDifferentIdType() {
            ...
            InvalidValue[] invalidValues = invalidCombination.GetValidationMessages();
        }
