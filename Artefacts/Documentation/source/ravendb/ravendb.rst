...
You can start with RavenDB by following the installation steps and using the RavenDB templify template from `S#arp Architecture releases <http://sharparchitecture.github.io/downloads.htm>`_.
